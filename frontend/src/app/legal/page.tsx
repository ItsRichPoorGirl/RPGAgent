                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Luciq AI
                      Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                      United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE LUCIQ
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Luciq AI Corp (
                        Los Angeles, California, United States).
                      </li>
                      <li>
                        "Site" refers to the Luciq website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Luciq website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@luciq.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Luciq is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@luciq.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@luciq.ai.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Luciq logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE LUCIQ WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      Luciq DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Luciq in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Luciq does not collect biometric or identifying
