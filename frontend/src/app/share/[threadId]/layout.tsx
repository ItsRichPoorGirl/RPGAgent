...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Luciq',
    description: 'Replay this Agent conversation on Luciq',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Luciq';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Luciq';
